...
#Angabe wie oft ein Modell gespeichert, geladen und wieder durchgespielt werden soll
Model_Loads=5
...
for i in range(Model_Loads):
    if i==0:
        LOAD_MODEL=None
    else:
        LOAD_MODEL= 'models/Differenz-vorher-nachher-128F-64Mini-0.001lr-lin-20k'+str(i-1)+'.model'
    MODEL_NAME = 'Differenz-vorher-nachher-128F-64Mini-0.001lr-lin-20k'+str(i)
