...
MODEL_NAME = 'Differenz-vorher-nachher-128F-64Mini-0.001lr-lin-20k'  
...
EPSILON_START = 1
EPSILON_END_1 = 0.1
EPISODES_END_1 = 0.6 * EPISODES
EPISODES_END_2 = EPISODES - EPISODES_END_1
#EPSILON_DECAY = 0.9999 #für long run diff vorher nachher
#EPSILON_DECAY = 0.9995 #für 10k Episoden
EPSILON_DECAY = 0.9992 #für 5k Episoden
MIN_EPSILON = 0.001
EPSILON_DECAY_LIN_1 = (EPSILON_START-EPSILON_END_1)/EPISODES_END_1
EPSILON_DECAY_LIN_2 = (EPSILON_END_1-MIN_EPSILON)/(EPISODES_END_2-1500)
...
for episode in tqdm(range(1, EPISODES + 1), ascii=True, unit='episodes'):
    ...
    Anfangspositionen, current_state, Anfangs_MHC = env.reset()
    ...
    while not done:   #Solange Aktionen ausführen, bis Endzustand oder Anzahl an Schritten erreicht wurde
        ...
        new_state, reward, done, info, MHC, Actual_Minimum, best_state = env.step(action)
    ...
    ep_Minimums.append(Actual_Minimum)
