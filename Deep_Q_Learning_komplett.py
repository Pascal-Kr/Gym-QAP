from gym_flp.envs.flp_env_Vers1_2D_Umgebung_veraenderliche_Farben_02 import qapEnv
...
env=qapEnv(mode ='rgb_array', instance='chr12a')


EPISODES = 3000
MIN_REWARD = -100  # For model save
MODEL_NAME = '64x2-chr12a'   #64 Filter und 2 Convolutional Layer
...
for episode in tqdm(range(1, EPISODES + 1), ascii=True, unit='episodes'):
    ...
    Anfangspositionen, current_state = env.reset()
